...
import type { TargetsBySection } from './process.types';

export const targetsBySection: TargetsBySection = {
  ...
  reporting_metrics: {
    ...
    targetLevel: 3,
    rationale: 'Набор KPI/KRI, регулярная управленческая отчетность и улучшения по метрикам.',
  },
